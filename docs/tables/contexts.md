...
This table uses `<table class="attention alert">`.

<table class="attention alert">
    <thead>
        <tr>
            <th>Column 1</th>
            <th>Column 2</th>
